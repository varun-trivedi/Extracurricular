...
document.addEventListener("DOMContentLoaded", function() {
    fetch("/bookvenue").then((res) =>{
        ...
        {
            arr.push(result[i]);
            document.getElementById("show_requests").innerHTML += "<h2>"+result[i].rollNo+"<br>"+result[i].venue+"<br>"+result[i].date.slice(0,10)+"<br>"+result[i].email+"</h2><input name='approval' type='checkbox' id= '"+"check"+i+"'><label for='approval'> Check to approve </label><br></br>";
        }
